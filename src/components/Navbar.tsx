  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="w-full flex justify-between items-center px-8 md:px-20 py-4 fixed top-0 text-gray-900 bg-gray-50/90 dark:text-white backdrop-blur-md dark:bg-gray-900/80 h-16"
      >
        {/* Logo Animation */}
        <motion.div
          initial={{ y: -50, opacity: 0 }}
