  ...
  return (
    <div className="relative z-10 flex flex-col items-center justify-center h-screen text-black dark:text-white">
      <div className="max-w-2xl text-center">
        ...
        <p
          className=" bg-clip-text text-transparent text-center text-4xl sm:text-6xl mb-4 font-extrabold"
          style={{
            backgroundImage:
        ...
        <p className="px-20 mb-4 text-center text-xl ">
          ...
          <span className=" text-blue-500 dark:shadow-md dark:shadow-white shadow-md shadow-black bg-transparent rounded-md font-bold">
            MERN
          </span>{" "}
